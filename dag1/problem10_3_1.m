...
%Since the manipulated variable p_c in this case is the setpoint for the p
%controller, the constraint should also be implemented for the manipulated
%variable
...
P1 = 0.1*ones(mx,1)';                   % Weight on input
Q = 2*genq2(Q1,1,N,M,mu);              % Generate Q
...
tic
[z,lambda] = quadprog( Q, [], [], [], Aeq, beq, vlb, vub, x0);
t1=toc;
